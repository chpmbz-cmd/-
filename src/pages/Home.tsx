          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10">
            {[
              ...
              >
                <Link
                  to={item.href}
                  className="group relative p-8 rounded-3xl bg-gray-50 hover:bg-navy-950 transition-all duration-500 flex flex-col items-center text-center overflow-hidden h-full"
                >
